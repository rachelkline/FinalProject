							...
							<Col xs={12} sm={12} md={6} lg={6}>
								...
								<Form>
									...
									<Form.Group>
										<Row>
											<Col>
												<Form.Label htmlFor="name"><strong>First name</strong></Form.Label>

												<Form.Control placeholder="John" size="lg"/>
											</Col>
											<Col>
												<Form.Label htmlFor="name"><strong>Last name</strong></Form.Label>
...
<br/>
									...
									<Button variant="outline-primary" size="lg" type="submit"><Link to="/login" className={useLocation.pathname === "/login"}>Cancel</Link>
