    ...
    return (
      <div>
        <Card>
          <Card.Body>
            {showHideDemo1 && <Demo1 />}
            {showHideDemo1 && <Button onClick={() => this.hideComponent("showHideDemo1")} variant="primary">Request Payment</Button>}
            ...
            {showHideDemo3 && <Demo3 />}
            {showHideDemo3 && <Button onClick={() => this.hideComponent("showHideDemo3")} variant="primary">Cancel</Button>}
